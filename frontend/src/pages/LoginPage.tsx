    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-6 bg-cyber-bg">
      <div className="w-full max-w-md bg-cyber-card border border-cyber-border rounded-2xl p-8 shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-bold text-slate-100 font-sans">Security Authentication</h1>
          <p className="text-xs text-slate-400 font-mono">Sign in to access PhishGuard AI Threat Engine</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="analyst@phishguard.sec"
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-mono font-medium text-slate-300">Security Password</label>
            <div className="relative">
